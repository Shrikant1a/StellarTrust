    ...
    <div className={styles.container}>
      ...
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.navMenu}>
          ...
          <Link href="/projects" className={`${styles.navItem} ${pathname.startsWith('/projects') && pathname !== '/projects/create' ? styles.active : ''}`}>
            <FolderIcon size={20} className={pathname.startsWith('/projects') && pathname !== '/projects/create' ? styles.activeIcon : ''} />
            Projects
          </Link>
          <Link href="/projects/create" className={`${styles.navItem} ${pathname === '/projects/create' ? styles.active : ''}`}>
            <CalendarPlus size={20} className={pathname === '/projects/create' ? styles.activeIcon : ''} />
            Create Project
          </Link>
          <Link href="/disputes" className={`${styles.navItem} ${pathname === '/disputes' ? styles.active : ''}`}>
            <CheckSquare size={20} className={pathname === '/disputes' ? styles.activeIcon : ''} />
            Disputes
          </Link>
          <Link href="/wallet" className={`${styles.navItem} ${pathname === '/wallet' ? styles.active : ''}`}>
        ...
        <div style={{ position: 'relative' }}>
          {isUserMenuOpen && (
            <div style={{
              ...
              <div style={{ padding: '8px 12px', color: '#a0a0b2', fontSize: '13px', borderBottom: '1px solid #2d2d3d', marginBottom: '4px' }}>
                Connected as<br/>
                <strong style={{ color: '#ffffff', fontSize: '14px' }}>0x1234...5678</strong>
              </div>
              <button 
          ...
          <div className={styles.userProfile} onClick={() => setIsUserMenuOpen(!isUserMenuOpen)}>
            ...
            <div className={styles.userInfo}>
              ...
              <p className={styles.userAddress}>0x1234...5678</p>
            </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div>
                  ...
                  <input type="text" readOnly value="0x1234567890abcdef1234567890abcdef12345678" style={{ width: '100%', padding: '10px 14px', backgroundColor: '#151521', border: '1px solid #2d2d3d', borderRadius: '8px', color: '#fff', fontSize: '14px' }} />
                </div>
                <div>
